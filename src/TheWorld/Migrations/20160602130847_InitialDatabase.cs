...
namespace TheWorld.Migrations
{
    public partial class InitialDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_Entry_WebPost_WebPostId", table: "Entry");
            ...
            migrationBuilder.AddForeignKey(
                ...
                onDelete: ReferentialAction.Cascade);
            migrationBuilder.AddForeignKey(
                name: "FK_Entry_WebPost_WebPostId",
                table: "Entry",
                column: "WebPostId",
                principalTable: "WebPost",
                principalColumn: "Id",
                onDelete: ReferentialAction.Cascade);
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_IdentityUserRole<string>_WorldUser_UserId", table: "AspNetUserRoles");
            migrationBuilder.DropForeignKey(name: "FK_Entry_WebPost_WebPostId", table: "Entry");
            migrationBuilder.DropColumn(name: "PostBytes", table: "Entry");
            migrationBuilder.DropColumn(name: "PostString", table: "Entry");
            migrationBuilder.AddForeignKey(
                name: "FK_IdentityRoleClaim<string>_IdentityRole_RoleId",
                table: "AspNetRoleClaims",
                column: "RoleId",
